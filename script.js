...
document.querySelectorAll('.section-title, .project-card, .skill-category, .about-text, .contact-info').forEach(el => {
    observer.observe(el);
});

// Typing effect for hero subtitle
const heroSubtitle = document.querySelector('.hero-subtitle');
const subtitles = ['Full Stack Developer', 'UI/UX Designer', 'Problem Solver', 'Creative Thinker'];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const elements = document.querySelectorAll('button, .btn, .nav-link, .project-card, .skill-item');
    elements.forEach(el => {
